...
static int set_espectroscopia(sensor_t *sensor)
{
    int ret=0;

    SET_REG_BITS_OR_RETURN(BANK_DSP, 0x44, 0, 0b11111111, 0b00000000) //Qs
    SET_REG_BITS_OR_RETURN(BANK_DSP, CTRL3, 0, 0b11000000, 0b00000000) //
    SET_REG_BITS_OR_RETURN(BANK_DSP, CTRL0, 0, 0b11111111, 0b00000001)
    SET_REG_BITS_OR_RETURN(BANK_DSP, CTRL1, 0, 0b11111111, 0b00000000)
    SET_REG_BITS_OR_RETURN(BANK_DSP, 0xDA, 0, 0b01001100, 0b00000100)
...
int ov2640_init(sensor_t *sensor)
{
    ...
    sensor->set_espectroscopia = set_espectroscopia;
